...
@interface UIApplication (SWIFT_EXTENSION(Bond))
@end
...
@property (nonatomic, readonly, strong) ProtocolProxy * _Nonnull bnd_delegate;
@property (nonatomic, readonly, strong) ProtocolProxy * _Nonnull bnd_dataSource;
@end
